...
**Step 3:** Update `worlds/aethermourne/vault/CHANGELOG.md` — add an entry for this cycle. Include date and time (run `date '+%Y-%m-%d %H:%M'`), a title, and what was created/updated.
