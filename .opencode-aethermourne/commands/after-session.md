...
2. Did the party gain or lose any notable items or divine materials?
...
1. **`Aethermourne/NPCRegistry.md`**, status changes, new NPCs, last-seen session
2. **`Aethermourne/PartyState.md`**, items, allies, enemies, debts, current location
3. **`Aethermourne/Sessions/Ongoing Threads.md`**, thread progress
4. **`Aethermourne/Timeline.md`**, key events from this session
5. Affected `.md` files in **`Aethermourne/Compendium/`**, use Grep to find NPC/faction/location files, then Edit
6. Affected `.md` files in **`Aethermourne/Players/`**, use Grep to find relevant PC files, then Edit
