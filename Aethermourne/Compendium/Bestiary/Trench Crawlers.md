...
*The first thing you hear is the clicking. Then you see the light, cold blue, pulsing in patterns too regular to be natural. Then you see the legs.*

> [!info]
> | | |
> |---|---|
> | **Region** | [[The Hollowed Reach]], [[The Hollowed Reach#The Abyssal Trench|Abyssal Trench]], coastal settlements during [[The Hollowed Reach#Black Tides|Black Tides]] |
> | **Origin** | Deep-sea arthropods from the upper Abyssal Trench |
> | **Threat Level** | Minor nuisance (individually), serious threat (swarms during Black Tides) |
> | **Associated God** | [[The Twelve#Yvenne|Yvenne]] / [[The Twelve#Serith|Serith]] |
...
Trench Crawlers surface during Black Tides, crawling up through storm drains, sea caves, and the tidal pools along the [[The Hollowed Reach#The Shattered Coast|Shattered Coast]]. They are drawn to warmth and light, which makes coastal settlements irresistible. Individually they are manageable, a nuisance that a watchman with a spear can handle. In swarms of a dozen or more, which is how they appear during major Black Tide events, they overwhelm through sheer numbers, clicking chitin and cold blue light flooding through streets already ankle-deep in dark water.
...
>
> A scholar who studies the recorded patterns (DC 18 Arcana or History, with access to Lantern-Keeper archives) can begin to decode fragments. The fragments are not messages. They are structural data, the mathematical signature of divine bone-cage failing under sustained pressure. This information is campaign-significant if delivered to [[Celestine Vael]] or [[The Star-Readers]].
>
> **Scaling.** 2-3 Crawlers are an easy encounter for level 1 PCs. A swarm of 8-12 during a Black Tide is a serious threat for level 3-4 parties, especially in flooded streets where the Crawlers have terrain advantage.
...
> |---|---|---|---|---|---|---|---|---|
> | Trench Crawler | 1 | L | 12 | 6 | +1 | +3 | -2 | 1d6 slashing pincers |
>
> **Resistances/Immunities:** Immune to cold (deep-sea adapted). Resistant to pressure-based damage.
>
> **Special Abilities:**
> - **Wall Climb.** Moves at full speed on vertical surfaces and ceilings.
> - **Numbing Venom (on pincer hit).** Target makes Str save DC 11 or the struck limb is paralyzed for 1d4 rounds. If both arms are paralyzed, the target drops held items.
> - **Swarm Tactics.** When 3+ Crawlers are adjacent to the same target, all gain advantage on attacks against that target.
> - **Drag.** A paralyzed target adjacent to 2+ Crawlers is dragged 2 spaces toward the nearest body of water at the end of each round.
>
> **Bloodied:** The Crawler's bioluminescence flares, signaling distress. All Crawlers within 6 spaces gain +1 to attack rolls for 1 round (swarming instinct).
>
> **Weakness:** Fire damage causes the chitin to crack (removes armor for 1 round). Bright light (daylight spell or equivalent) causes Crawlers to flee toward the nearest dark, wet space.
>
> **Recommended Party Size:** 3-4 players of level 1-2 (per group of 3-4 Crawlers)
