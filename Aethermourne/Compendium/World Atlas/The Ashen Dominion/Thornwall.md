...
Thornwall sits in the Scar, the violent ecological collision zone where [[The Twelve#Solvaen|Solvaen's]] legacy of order meets [[The Twelve#Thyrea|Thyrea's]] legacy of wild growth. The settlement exists in a landscape that shouldn't work: calcified trees threaded with living vines, grey ash erupting with luminous thorned growth, [[Cosmology and Magic#Ashite|Ashite]] formations wrapped in pulsing moss. The air smells of mineral dust and green sap in equal measure, and the wind carries sounds from the Scarwall that the garrison has learned not to investigate.
...
> [!warning]- GM Only
> Ashgrove's correlation is correct. The Black Tides, the Scarwall's growth, and the Star Fade are all symptoms of the same underlying cause: [[The Twelve#Serith|Serith's]] prison weakening and divine boundaries destabilizing across Aethermourne. Ashgrove doesn't have the theological framework to understand what she's found, but her data is the kind of evidence that could connect seemingly unrelated events across multiple regions, if it reaches the right hands.
...
> [!warning]- GM Only
> The movement is a Cinder operative from the Marches side, using thorn-tunnels through the Scarwall as a covert route between the two nations. [[Delric Mourne]] maintains communication with Serith-aligned agents in the Marches through this channel. The encrypted message contains instructions to accelerate Thornwall's supply disruption.
