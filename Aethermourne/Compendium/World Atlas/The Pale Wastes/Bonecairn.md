...
A bone-harvesting outpost perched at the edge of a major Marrow Field, Bonecairn is the closest permanent settlement to the [[The Pale Wastes#The Hollowdeep|Hollowdeep]] besides [[Lastlight]]. Where Lastlight watches, Bonecairn works. The Hold exists for one reason: extracting [[The Pale Wastes#The Marrow Fields|Morrhaelite]] and divine bone fragments from [[The Twelve#Morrhael|Morrhael's]] remains and shipping them south to [[Ember's Rest]] for trade.
...
> [!warning]- GM Only
> The geometric markings on the bone fragments are [[The Twelve#Serith|Serith's]] work, inscribed through the death-domain into [[The Twelve#Morrhael|Morrhael's]] physical remains. They are command-glyphs, a language of control being carved into the bones so that when Serith is ready, she can direct the undead army with precision across the entire Wastes simultaneously. The Ward Ring failure was a test: Serith learning to siphon ward-energy through the bones, a technique that could neutralize every Hold's defenses at once.
