...
description: Template structure for session documents. Load this skill when creating or editing session files.
---

## Session Document Template

All session documents follow this structure. When creating a new session file or editing an existing one, maintain this format.

### File naming convention
`Session N_ Title - YYYY-MM-DD.md` (colons replaced with underscores in filenames)

### File location
Session files go in `{{VAULT_FOLDER}}/Sessions/`
